...
restricted for this repository, and the repository does not expose a public
Discussions page. Check the issue list for a matching issue and whether its
thread accepts comments; keep privacy-safe results local if no public route
...
label it exploratory and include the blocked reasons rather than enlarging or
repeating selected clips to meet a threshold.
