    ...
    def _build(self):
        ...
        ttk.Label(
            ...
            text=("The microphone check is optional: you can finish Setup "
                  ...
                  "an unsigned app may appear as Unsigned. Audio samples are "
                  ...
                  "apps access your microphone. If your build also offers "
                  "per-app desktop controls, check the Presspeech entry; do "
                  "not allow an unfamiliar or unverified entry. If Windows "
                  "says these settings "
