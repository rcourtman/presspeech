...
- [Presspeech-Setup-0.1.5-x64.exe](https://github.com/rcourtman/presspeech/releases/download/windows-v0.1.5/Presspeech-Setup-0.1.5-x64.exe)
- [Release notes and SHA-256 checksum](https://github.com/rcourtman/presspeech/releases/tag/windows-v0.1.5)
...
powershell -ExecutionPolicy Bypass -File .\build-release.ps1 -Version 0.1.5
```
